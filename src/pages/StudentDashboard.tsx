...
const StudentDashboard = () => {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      {/* Background Effects */}
      <div className="fixed top-1/4 right-1/4 w-[500px] h-[500px] bg-gold/5 rounded-full blur-[150px] pointer-events-none" />
      <div className="fixed bottom-1/4 left-1/4 w-[400px] h-[400px] bg-bronze/5 rounded-full blur-[120px] pointer-events-none" />
